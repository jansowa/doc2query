...
| [05](05_controlled_diversity_and_multiquery.md) | Kontrolowany styl, focus i multi-query | `IMPLEMENTED` | D01 1.5B/4.5B treningi i pełne frozen-dev generacje są technicznie ukończone oraz zaudytowane, bez interpretacji jakości. Matched W05/W06 batched-v2 ukończyły 6598 passage; quality-blind exact-K recovery zmaterializowało 5321 wspólnych grup / 21284 query na ramię. Legacy model provenance bez pola `architecture` jest jawnie oznaczane przy ścisłej zgodności model ID/revision/trust. Następne są scoring/comparison/probe-input gate. Groq audit pozostaje osobnym procesem; matched scoring, probe training/CI, human check i pozostałe D00–D12 nie są zmierzone. |
