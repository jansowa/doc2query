...
| [06](06_candidate_scoring_and_preference_data.md) | Scoring kandydatów i dane preferencyjne | `IN PROGRESS` | Gotowy jest model-free fundament: ścisłe kontrakty, deterministyczna selekcja par, kontrola leakage, TRL/continued-SFT export i ślepy audyt A/B, zweryfikowane 28 lekkimi testami. Generacja, scoring sędziami, materializacja właściwego zbioru i audyt człowieka pozostają zamknięte do rozstrzygnięcia Task 05 oraz osobnej prospektywnej konfiguracji. |
