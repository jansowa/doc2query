...
| [09](09_experiment_campaign.md) | Kampania eksperymentalna | `BLOCKED` | P06-T zostało świadomie anulowane i nie jest już zależnością. Kampania nadal wymaga pełnej bramki hard negative'ów oraz wcześniejszych etapów dopuszczonych przez kontrakt statystyczny; P-06 mass rescoring również nie jest zależnością. |
...
Najbliższy punkt wejścia to pełna bramka hard negative'ów na zamrożonym dev.
