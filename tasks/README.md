...
| [05](05_controlled_diversity_and_multiquery.md) | Kontrolowany styl, focus i multi-query | `IMPLEMENTED` | D01 1.5B/4.5B i retrospektywna diagnostyka D01b są ukończone, ale nie autoryzują probe. Przed generacją zamrożono prospektywną kohortę 2000 rekordów z `dev_intrinsic` poza użytym rank-10, minimum 5 hard negative’ów, selekcję SHA-256 seed 20260802, selector `2164822`, sędziów i bramki; `final_tests_used=[]`. Tanie fazy runnera przeszły, lecz `generate` zatrzymało się fail-closed przed scoringiem: controlled ma 8000/8000 query, W05 7547/8000 i 320 grup bez exact K. Treści query nie przeglądano. Obecnego journala nie można legalnie wznowić do kompletności; retry wymaga nowego ADR na nadal niewidzianej kohorcie z jawną polityką exact-K. Probe, 4.5B i finalne testy pozostają zamknięte. Groq proxy ukończył 500/500 etykiet i 200/200 audytów; agreement człowieka pozostaje `NOT MEASURED`, a D00–D12 poza D01 nie są zmierzone. |
