...
| [05](05_controlled_diversity_and_multiquery.md) | Kontrolowany styl, focus i multi-query | `IMPLEMENTED` | Gotowe są kontrakty i kod CPU, w tym wznawialny post-D01 pipeline oraz niezależny pakiet natural-query calibration/audits. Na pełnym `dev_intrinsic_rank10` zmaterializowano opisową kalibrację reguł i prospektywne ślepe próbki 500 etykiet oraz 200 pasaży; formularze nie mają ocen, więc oba audyty pozostają `NOT MEASURED`. Nocna kolejka D01 nie została uruchomiona; D00–D12, human check i probe z CI nadal są niewykonane. |
