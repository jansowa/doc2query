...
| [06](06_candidate_scoring_and_preference_data.md) | Scoring kandydatów i dane preferencyjne | `IN PROGRESS` | Gotowy jest model-free fundament oraz deterministyczny planner requestów K=4–8: ścisłe kontrakty, coverage-first osie style/focus/temperature/seed, kontrola leakage i zakaz testu, selekcja par, TRL/continued-SFT export i ślepy audyt A/B; 32 lekkie testy przechodzą. Ładowanie generatora, scoring sędziami, materializacja właściwego zbioru i audyt człowieka pozostają zamknięte do rozstrzygnięcia Task 05 oraz osobnej prospektywnej konfiguracji. |
