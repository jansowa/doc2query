...
| [05](05_controlled_diversity_and_multiquery.md) | Kontrolowany styl, focus i multi-query | `IMPLEMENTED` | D01 1.5B/4.5B treningi i pełne frozen-dev generacje są technicznie ukończone oraz zaudytowane, bez interpretacji jakości. Ze względu na 6/8 exhausted groups przyjęto quality-blind wspólną kohortę exact-K po wygenerowaniu matched W05 i rzeczywistego W06 BS8. Przerwany batch-1 baseline zachowano (220 passage); benchmarkowana, wznawialna ścieżka batched-v2 z batchem 16 jest gotowa pod osobnymi artefaktami. Następne są pełna baseline generation, recovery/scoring/comparison/probe-input gate. Groq audit pozostaje osobnym procesem; matched scoring, probe training/CI, human check i pozostałe D00–D12 nie są zmierzone. |
