...
| [04](04_evaluation_harness.md) | Harness ewaluacyjny | `IMPLEMENTED` | Harness, fingerprinty, testy i realna intrinsic W03/W05 (greedy + diverse, primary judge, bootstrap) są gotowe; probe przeszedł tylko 2-step smoke. Pozostały pełne probe’y natural/copy/W03/W05, BGE shadow, embedding diversity, 300 ocen ludzi, pełny test i S00; bramka Fazy B pozostaje otwarta. |
