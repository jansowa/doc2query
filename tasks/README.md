...
| [03](03_sft_qlora_baselines.md) | Baseline'y SFT/QLoRA | `IMPLEMENTED` | Po braku promocji P-05 zamrożono kolejność `S00 → decyzja S07/P-06`. S00 ma frozen-dev preflight oraz wznawialny runner 5k zero/few-shot; generacja batchuje 8 promptów i automatycznie zmniejsza batch po OOM, zachowując istniejący journal. Pełny run/scoring S00 i pomiar przyspieszenia pozostają niewykonane, podobnie S07/P-06; `dev_confirm` i testy finalne są zamknięte. |
